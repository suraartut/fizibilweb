  ...
  return (
    <div className="w-full pt-[88px]">
      <div className="w-full">
        <img
          src="/assets/Images/mobil-program-banner.png"
        ...
        <div className="lg:mx-0 mx-5">
          ...
          <div className="lg:flex gap-20 items-center">
            ...
            <div>
              <p className="lg:pb-3 pb-2">
                Dijital evrimin hız kazandığı bu çağda, mobil cihazlar dünyamızı
                şekillendiriyor. Biz, bu değişimin liderleri olarak, mobil
                dünyanın kapılarını sizin için aralıyoruz. Yazılımın gücünü
                taşınabilir cihazlarınızla birleştirerek, işinizi ve hayatınızı
              ...
              <p className="lg:pb-3 pb-2">
                İş ortağınız olarak, mobil projelerinizde başarıya ulaşmanıza
                yardımcı oluyoruz. Mobil dünyada fark yaratmak ve işletmenizi
                bir üst seviyeye taşımak için bize katılın.
              </p>
            </div>
          </div>
          <div className="lg:my-10 my-4">
            ...
            <p className="lg:pb-6 pb-3">
              İşletmenizin mobil stratejisini oluşturmak, uygulamak ve optimize
              etmek için size özel çözümler sunuyoruz. Kullanıcı taleplerini
              anlamak, rekabeti analiz etmek ve sektördeki güncel gelişmeleri
              takip etmek için deneyimli bir danışman ekibiyle çalışarak işinizi
              dijital dünyada güçlendirebilirsiniz.
            </p>
            ...
            <p className="pb-2 lg:w-[40%] text-center mx-auto">
              ...
              projelerinizde büyümenize ve başarılı olmanıza yardımcı oluyoruz.
              Haydi, birlikte mobil dünyasında iz bırakalım!
            </p>
          </div>
        </div>
